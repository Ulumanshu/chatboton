...
SYSTEM_PROMPT = (
    ...
    "gadget store:\n"
    "- query_postgres: SQL over products(id, name, category, price_eur, stock).\n"
    "- query_neo4j: Cypher over (:Customer)-[:BOUGHT {qty}]->(:Product).\n"
    "- search_reviews: semantic search over customer review texts.\n"
    "- search_products_v2: vector similarity search in Qdrant.\n"
    "- full_text_search: keyword search in OpenSearch.\n"
